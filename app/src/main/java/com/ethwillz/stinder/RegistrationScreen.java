...
//                .enableAutoManage(this, this)
        ...
        resetPass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(RegistrationScreen.this, ResetPassword.class));
            }
        });
                ...
                authent.createUserWithEmailAndPassword(inputEmail, inputPass)
                        .addOnCompleteListener(RegistrationScreen.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                Toast.makeText(RegistrationScreen.this, "createUserWithEmail:onComplete:" + task.isSuccessful(), Toast.LENGTH_SHORT).show();

                                if (!task.isSuccessful()) {
                                    Toast.makeText(RegistrationScreen.this, "Authentication Failed" + task.getException(), Toast.LENGTH_LONG).show();
                                } else {
                                    ...
                                    startActivity(new Intent(RegistrationScreen.this, MainScreen.class));
                                    finish();
                                }
                            }
                        });
